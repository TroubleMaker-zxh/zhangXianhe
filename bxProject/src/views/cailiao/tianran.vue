        ...
        <standard-form-row title="所属类目" block style="padding-bottom: 11px;">
          <a-form-item>
            <tag-select>
              ...
              <tag-select-option value="Category11">类目十一</tag-select-option>
              <tag-select-option value="Category12">类目十二</tag-select-option>
              <tag-select-option value="Category13">类目十三</tag-select-option>
              <tag-select-option value="Category14">类目十四</tag-select-option>
              <tag-select-option value="Category15">类目十五</tag-select-option>
              <tag-select-option value="Category16">类目十六</tag-select-option>
              <tag-select-option value="Category17">类目十七</tag-select-option>
              <tag-select-option value="Category18">类目十八</tag-select-option>
              <tag-select-option value="Category19">类目十九</tag-select-option>
              <tag-select-option value="Category20">类目二十</tag-select-option>
            </tag-select>
          </a-form-item>
        </standard-form-row>
